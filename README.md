...
### Problem Statement
Complaints can give us insights into problems people are experiencing in the marketplace and help us to understand the reason and make necessary modifications in existing financial products if required.
...
The problem is to identify registered complaint will be disputed by the customer or not.
## Tech Stack Used
1. Python 
2. PySpark
3. PySpark ML
